...
require get_template_directory() . '/inc/ample-themes/widgets/business-service-widgets.php';
require get_template_directory() . '/inc/ample-themes/widgets/business-Quote-widgets.php';
require get_template_directory() . '/inc/ample-themes/widgets/business-team-widgets.php';
require get_template_directory() . '/inc/ample-themes/widgets/business-testimonials-widgets.php';
require get_template_directory() . '/inc/ample-themes/widgets/business-recents-post-widgets.php';
require get_template_directory() . '/inc/ample-themes/widgets/our-work-service-widgets.php';
require get_template_directory() . '/inc/ample-themes/widgets/business-epic-info-widgets.php';
require get_template_directory() . '/inc/ample-themes/metabox/metabox-page-post-sidebar.php';
require get_template_directory() . '/inc/ample-themes/customizer/layout-design/business-layout-functions.php';
