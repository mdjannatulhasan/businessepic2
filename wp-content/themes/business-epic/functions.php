...
if ( ! function_exists( 'business_epic_setup' ) ) :
	...
	function business_epic_setup() {
         ...
         */
		load_theme_textdomain( 'business-epic' );
		...
		add_theme_support( 'custom-header', $business_epic_args );
 ...
 * Load Dynamic css.
 */
$business_epic_dynamic_css_options = business_epic_get_option('business_epic_color_reset_option');

if ($business_epic_dynamic_css_options== "do-not-reset" || $dynamic_css_options == "") {

	include get_template_directory() . '/inc/hook/dynamic-style-css.php';

} elseif ($business_epic_dynamic_css_options == "reset-all") {
